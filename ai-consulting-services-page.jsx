    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
      ...
      <nav className="bg-white/95 backdrop-blur sticky top-0 z-50 border-b border-slate-200">
        <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
          <div className="text-2xl font-bold text-slate-900">AI First Solutions</div>
          ...
          <div className="bg-white rounded-2xl p-8 md:p-12 shadow-2xl text-slate-900">
            {!submitted ? (
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  type="submit"
                  className="w-full bg-gradient-to-r from-blue-600 to-indigo-600 text-white py-4 px-8 rounded-xl font-bold text-lg hover:from-blue-700 hover:to-indigo-700 transition flex items-center justify-center gap-2 shadow-lg"
                >
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          ...
          "url": "https://aifirstsolutions.com",
          "telephone": "",
          "address": {
            "@type": "PostalAddress",
